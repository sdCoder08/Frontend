...
const ResourceForms = ({ visibleForm, setBooks, setWebsites, setVideos }) => {
    ...
    const onsubmit = async (data) => {
        if (data.formType === 'books') {
            ...
            await axios
                .post('http://localhost:4002/Books/AddBook', bookInfo)
                .then((response) => {
                    if (response.data) {
        ...
        if (data.formType === 'videos') {
            ...
            await axios
                .post('http://localhost:4002/Videos/AddVideo', videoInfo)
                .then((response) => {
        ...
        if (data.formType === 'websites') {
            ...
            await axios
                .post('http://localhost:4002/Websites/AddWebsite', websiteInfo)
                .then((response) => {
