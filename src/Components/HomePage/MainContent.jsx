...
const MainContent = () => {
    ...
    //         try {
    //             const response = await axios.get('http://localhost:4002/Documents/getDocuments', {
    ...
    useEffect(() => {
        const fetchDeadlines = async () => {
          try {
            const response = await axios.get('http://localhost:4002/Event/GetEvent', {
              params: { userId: userId },
            });
      ...
      useEffect(() => {
        const fetchGoals = async () => {
          try {
            const response = await axios.get('http://localhost:4002/Goals/getGoal', {
              params: { userId: userId },
            });
      ...
      useEffect(() => {
        const fetchTasks = async () => {
          try {
            const response = await axios.get('http://localhost:4002/Tasks/getTask', {
              params: { userId: userId },
            });
