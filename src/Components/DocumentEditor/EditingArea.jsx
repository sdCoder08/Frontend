...
const EditingArea = () => {
    ...
    useEffect(() => {
        const getContent = async () => {
            try {
                const content = await axios.get('http://localhost:4002/Documents/getContent', { params: { userId: userId, currentdoc: currentdoc } })
                if(content.data){
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:4002/Documents/createDocument', docData);
