...
const TasksAndGoals = ({ routines, setRoutines, tasks, setTasks, goals, setGoals, visibleTable, handleVisibleForm }) => {
    ...
    useEffect(() => {
        const getGoal = async () => {
            try {
                const response = await axios.get('http://localhost:4002/Goals/GetGoal', { params: { userId } })
    ...
    useEffect(() => {
        const getTask = async () => {
            try {
                const response = await axios.get('http://localhost:4002/Tasks/GetTask', { params: { userId } })
    ...
    useEffect(() => {
        const getRoutine = async () => {
            try {
                const response = await axios.get('http://localhost:4002/Routine/GetRoutine', { params: { userId } })
    ...
    const deleteTask = async (index) => {
        ...
        try {
            const response = await axios.delete('http://localhost:4002/Tasks/RemoveTask', {
    ...
    const deleteGoal = async (index) => {
        ...
        try {
            const response = await axios.delete('http://localhost:4002/Goals/RemoveGoal', {
    ...
    const deleteRoutine = async (index) => {
        ...
        try{
            const response = await axios.delete('http://localhost:4002/Routine/RemoveRoutine', {
